...
/**
 A class for capturing the result of a LjsUnixOperation.
 
 @warning This class is only meant to be instatiated by LjsUnixOperation.
 */
@interface LjsUnixOperationResult : NSObject
